...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Americanas.com - A Maior Loja da Inter_5cd4ca/input_Senha_password'), 
    'WaOMbPzzjLHozClb1GKkNQ==')

WebUI.setText(findTestObject('Object Repository/Page_Americanas.com - A Maior Loja da Inter_5cd4ca/input_CPF_cpf'), cpfRandom)
...
WebUI.verifyElementText(findTestObject('Page_Americanas.com - A Maior Loja da Inter_5cd4ca/div_NomeLogin'), nomecliente)

def GeradorMassa() {
    WebUI.openBrowser('')

    WebUI.navigateToUrl('https://www.4devs.com.br/gerador_de_cpf')

    WebUI.click(findTestObject('Object Repository/Page_Gerador de CPF - 4Devs/span_No_checkmark'))

    WebUI.click(findTestObject('Object Repository/Page_Gerador de CPF - 4Devs/input_No_bt_gerar_cpf'))

cpfRandom =    WebUI.getText(findTestObject('Object Repository/Page_Gerador de CPF - 4Devs/div_15974020014'))
